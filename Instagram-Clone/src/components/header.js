                        ...
                        {user ? (
                            <>
                                <Link to={ROUTES.DASHBOARD} arial-label="Home">
                                    <svg className="w-8 mr-6 text-black-light cursor-pointer" xmlns="htttp://www.w3.org/2000/svg"
                                ...
                                <button type="button" title="Sign Out" onClick={() => firebase.auth().signOut()}
                                    ...
                                    <svg className="w-8 mr-6 text-black-light cursor-pointer" xmlns="http://www.w3.org/2000/svg"
                                                fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
                            ...
                            <>
                                <Link to={ROUTES.LOGIN}>
                                    <button type="button" className="bg-blue-500 font-blod text-sm rounded text-white w-20 h-8">
                                        Log In
                                    </button>
                                </Link>
